...
namespace OfficeDeskReservationDB.Data
{
    ...
    public static class DataTransfer
    {
        ...
        public static string ImportDatabaseFromJson(AppDbContext context, string filePath)
        {
            ...
            if (backup == null) return "Error: Could not deserialize JSON.";
            ...
            if (addedUsers > 0 || addedDesks > 0) context.SaveChanges();
